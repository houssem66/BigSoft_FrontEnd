...
import BonCommandeService from '../../../Services/BonClient/DevisService';
    ...
    return (
        ...
        >
            <Grid sx={{ mt: 2, ml: 5, mx: 2 }} container spacing={5}>
                ...
                <Grid item md={2}>
                    <Button css={{ width: "100%" }} flat color="success" onClick={event => { navig("/feed/salesQuotes_add"); }} auto icon={<AddIcon />}>Add</Button>
                        ...
                        <Table.Body>
                            {filteredList.map(item => (
                                ...
                                <Table.Row key={item.id}>
                                    ...
                                    <Table.Cell>
                                        <IconButton onClick={() => {  navig('/feed/salesQuotes_edit/', { state: { Bon: item.id } });}} color="error" aria-label="Edit">
                                            <EditIcon />
                                        </IconButton>
                                        ...
                                        <IconButton onClick={() => {   navig('/feed/salesQuotes_details/', { state: { Bon: item.id } }); }} color="default" aria-label="Edit">
                                            <VisibilityIcon />
                                        </IconButton>
                                        <div>
