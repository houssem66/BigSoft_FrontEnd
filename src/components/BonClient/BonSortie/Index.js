    ...
    return (
        ...
        >
            <Grid sx={{ mt: 2, ml: 5, mx: 2 }} container spacing={5}>
                ...
                <Grid item md={2}>
                    <Button css={{ width: "100%" }} flat color="success" onClick={event => { navig("/feed/exitOrder_add"); }} auto icon={<AddIcon />}>Add</Button>
                        ...
                        <Table.Body>
                            {filteredList.map(item => (
                                ...
                                <Table.Row key={item.id}>
                                    ...
                                    <Table.Cell>
                                        <IconButton onClick={() => { navig('/feed/exitOrder_edit/', { state: { Bon: item.id } });}} color="error" aria-label="Edit">
                                            <EditIcon />
                                        </IconButton>
                                        ...
                                        <IconButton onClick={() => { navig('/feed/exitOrder_details/', { state: { Bon: item.id } }); }} color="default" aria-label="Edit">
                                            <VisibilityIcon />
                                        </IconButton>
                                        <div>
                                            ...
                                            >
                                                ...
                                                <DialogContent>
                                                    <DialogContentText id="alert-dialog-description"><p>  You will delete the Exit Order   !!</p>
