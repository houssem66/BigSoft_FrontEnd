                                    ...
                                    <Table.Cell>
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <DialogContent>
                                                    <DialogContentText id="alert-dialog-description"><p>  You will delete the Delivery order    <Typography component="h1" variant="h5">{item.date.toString().substring(0, 10)}</Typography> !!</p>
